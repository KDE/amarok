...
CollectionScanner::displayHelp()
{
    ...
    qerr << qPrintable( tr( "Amarok Collection Scanner\n\nNote: For debugging purposes this application can be invoked from the command line, but it will not actually build a collection this way." ) ) << endl;
    qerr << qPrintable( tr( "(C) 2003-2009, The Amarok Developers" ) ) << endl;
    qerr << qPrintable( tr( "IRC:\nserver: irc.freenode.net / channels: #amarok, #amarok.de, #amarok.es, #amarok.fr\n\nFeedback:\namarok@kde.org" ) ) << endl;
    qerr << qPrintable( tr( "Usage: amarokcollectionscanner [options] +Folder(s)" ) ) << endl;
    qerr << qPrintable( tr( "\n\nUser-modifiable Options:" ) ) << endl;
