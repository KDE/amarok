...
if(NOT WIN32)
    ...
    if(BINDINGS_RUN_RESULT EQUAL 1)
        ...
        set( BindingsErrorMessage "QtBindings not found. run `cd cmake/modules/bindingstest; mkdir build; cd build; cmake ..; make; ./bindingstest; echo $?` If it prints '0' then you're actually fine." )
        if(QtScriptQtBindings_FIND_REQUIRED)
            message( FATAL_ERROR ${BindingsErrorMessage} )
        else(QtScriptQtBindings_FIND_REQUIRED)
            message( STATUS ${BindingsErrorMessage} )
        endif(QtScriptQtBindings_FIND_REQUIRED)
        set( BindingsErrorMessage "" )
