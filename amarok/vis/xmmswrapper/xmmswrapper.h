...
extern "C"
{
    ...
    */
    ...
    //libxmms/util.h
    GtkWidget *xmms_show_message(gchar * title, gchar * text, gchar * button_text, gboolean modal, GtkSignalFunc button_action, gpointer action_data) { return 0;}
...
extern "C" {
    ...
    //xmms/util.h
    gchar *find_file_recursively(const char *dirname, const char *file) { return 0;}
    void del_directory(const char *dirname) {}
    GdkImage *create_dblsize_image(GdkImage * img) { return 0; }
    char *read_ini_string(const char *filename, const char *section, const char *key) { return 0; }
    char *read_ini_string_no_comment(const char *filename, const char *section, const char *key) { return 0; }
    GArray *read_ini_array(const gchar * filename, const gchar * section, const gchar * key) { return 0; }
    GArray *string_to_garray(const gchar * str) { return 0; }
    ...
    GtkWidget *util_create_add_url_window(gchar *caption, GtkSignalFunc ok_func, GtkSignalFunc enqueue_func) { return 0;}
    GtkWidget *util_create_filebrowser(gboolean clear_pl_on_ok) { return 0; }
    gboolean util_filebrowser_is_dir(GtkFileSelection * filesel) { return false; }
    GdkFont *util_font_load(gchar *name) { return 0; }
