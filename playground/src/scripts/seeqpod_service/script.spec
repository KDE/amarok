...
Name=Seeqpod.com
Comment=A scripted service that lets you search and stream music from all over the web using the Seeqpod.com search engine.

X-KDE-PluginInfo-Author=Nikolaj Hald Nielsen
X-KDE-PluginInfo-Email=nhnFreespirit@gmail.com
X-KDE-PluginInfo-Name=Seeqpod.com
