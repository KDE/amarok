...
k_dcop:
   ...
   virtual QString currentArtist() = 0;			    ///< Return the artist of the currently playing track
   virtual QString currentTitle() = 0;                      ///< Return the title of the currently playing track
   virtual QString currentAlbum() = 0;			    ///< Return the album of the currently playing track
   virtual QString currentTotalTime() = 0;		    ///< Return the total length of the currently playing track (format mm:ss)
   virtual QString currentPosition() = 0;		    ///< Return the position of the currently playing track (format mm:ss)
   virtual QString currentGenre() = 0;			    ///< Return the genre of the currently playing track
   virtual QString currentYear() = 0;			    ///< Return the year of the currently playing track
   virtual QString currentComment() = 0;		    ///< Return the comment of the currently playing track
   virtual QString currentBitrate() = 0;		    ///< Return the bitrate of the currently playing track
