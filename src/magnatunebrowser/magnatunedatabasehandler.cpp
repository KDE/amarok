...
int MagnatuneDatabaseHandler::insertTracks(MagnatuneTrackList tracks, int albumId, int artistId )
{
    ...
    queryString = "INSERT INTO magnatune_tracks ( name, track_number, length, " 
                  "album_id, artist_id, preview_lofi, preview_hifi ) VALUES ( '"
                  + db->escapeString((*it).getName()) + "', "
                  + QString::number((*it).getTrackNumber()) + ", "
                  + QString::number((*it).getDuration()) +", "
                  + QString::number(albumId) + ", "
                  + QString::number(artistId) + ", '"
                  + db->escapeString((*it).getLofiURL()) + "', '"
                  + db->escapeString((*it).getHifiURL()) + "' ); ";
