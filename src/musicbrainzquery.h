...
#ifndef AMAROK_MUSICBRAINZQUERY_H
#define AMAROK_MUSICBRAINZQUERY_H
 ...
 * It's pseudo-asynchronous. Pseudo because it depends on
 * asynchronous libmusicbrainz (someday we'll have to write
...
#endif /*AMAROK_MUSICBRAINZQUERY_H*/
