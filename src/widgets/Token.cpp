    ...
    , m_customColor( false )
{
    ...
    // note: the minimum and preferred size is defined by the children widgets
    // mainly for a container. So we set the content margins of the children
    // to have enough space for our frame.
