...
#ifndef AMAROK_MTPCOLLECTIONLOCATION_H
#define AMAROK_MTPCOLLECTIONLOCATION_H
...
class MtpCollectionLocation : public CollectionLocation
{
    Q_OBJECT
    public:
        MtpCollectionLocation( MtpCollection const *collection );
        virtual ~MtpCollectionLocation();
