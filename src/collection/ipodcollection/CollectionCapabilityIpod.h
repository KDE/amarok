...
#ifndef COLLECTIONCAPABILITYIPOD_H
#define COLLECTIONCAPABILITYIPOD_H
...
class CollectionCapabilityIpod : public CollectionCapability
{

    Q_OBJECT

    public:
        CollectionCapabilityIpod( IpodCollection *coll );
