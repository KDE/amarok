 ...
 * Copyright (c) 2026 Arturo Garcia-Vargas <arturo@ficuslabs.com>                       *
 *                                                                                      *
...
static void doUpgradeVersion4to5( SqlStorage *storage )
{
    ...
    columns.insert( QStringLiteral("albums"), vcpair( QStringLiteral("name"), DatabaseUpdater::textColumnLength() ) );
    ...
    columns.insert( QStringLiteral("artists"), vcpair( QStringLiteral("name"), DatabaseUpdater::textColumnLength() ) );
    ...
    columns.insert( QStringLiteral("composers"), vcpair( QStringLiteral("name"), DatabaseUpdater::textColumnLength() ) );
    ...
    columns.insert( QStringLiteral("labels"), vcpair( QStringLiteral("label"), DatabaseUpdater::textColumnLength() ) );
    ...
    columns.insert( QStringLiteral("tracks"), vcpair( QStringLiteral("title"), DatabaseUpdater::textColumnLength() ) );
    ...
    columns.insert( QStringLiteral("years"), vcpair( QStringLiteral("name"), DatabaseUpdater::textColumnLength() ) );
...
static void doUpgradeVersion9to10( SqlStorage *storage )
{
    ...
    columns.insert( QStringLiteral("devices"), vcpair( QStringLiteral("sharename"), 240 ) );
    columns.insert( QStringLiteral("directories"), vcpair( QStringLiteral("dir"), 1000 ) );
    columns.insert( QStringLiteral("genres"), vcpair( QStringLiteral("name"), DatabaseUpdater::textColumnLength() ) );
    columns.insert( QStringLiteral("images"), vcpair( QStringLiteral("path"), 255 ) );
    columns.insert( QStringLiteral("labels"), vcpair( QStringLiteral("label"), DatabaseUpdater::textColumnLength() ) );
    columns.insert( QStringLiteral("lyrics"), vcpair( QStringLiteral("url"), 324 ) );
    columns.insert( QStringLiteral("playlist_groups"), vcpair( QStringLiteral("name"), 255 ) );
