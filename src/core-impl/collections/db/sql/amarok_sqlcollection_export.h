...
#   define AMAROK_SQLCOLLECTION_EXPORT Q_DECL_EXPORT
# else
   /* We are using this library */
#   define AMAROK_SQLCOLLECTION_EXPORT Q_DECL_IMPORT
# endif
#endif
...
# if defined(MAKE_AMAROK_COLLECTION_MYSQLECOLLECTION_LIB)
   /* We are building this library */
#   define AMAROK_SQLCOLLECTION_MYSQLE_EXPORT Q_DECL_EXPORT
# else
   /* We are using this library */
#   define AMAROK_SQLCOLLECTION_MYSQLE_EXPORT Q_DECL_IMPORT
# endif
#endif

# ifndef AMAROK_SQLCOLLECTION_EXPORT_DEPRECATED
#  define AMAROK_SQLCOLLECTION_EXPORT_DEPRECATED QT_DEPRECATED AMAROK_SQLCOLLECTION_EXPORT
# endif
