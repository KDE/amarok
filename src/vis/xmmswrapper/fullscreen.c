...
gboolean xmms_fullscreen_init(GtkWidget *)
{
	return FALSE;
}

gboolean xmms_fullscreen_enter(GtkWidget *, gint *, gint *)
{
	return FALSE;
}
void xmms_fullscreen_leave(GtkWidget *)
{
	return;
}

gboolean xmms_fullscreen_in(GtkWidget *)
{
	return FALSE;
}
gboolean xmms_fullscreen_mark(GtkWidget *)
{
	return FALSE;
}
void xmms_fullscreen_unmark(GtkWidget *)
{
	return;
}

void xmms_fullscreen_cleanup(GtkWidget *)
{
	return;
}

GSList *xmms_fullscreen_modelist(GtkWidget *)
{
	return NULL;
}
void xmms_fullscreen_modelist_free(GSList *)
{
	return;
}
