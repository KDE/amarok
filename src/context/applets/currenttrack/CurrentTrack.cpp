...
{
    return KColorScheme( QPalette::Disabled ).foreground( KColorScheme::NormalText );
}

QString
CurrentTrack::handleUnknown( QString original, TextScrollingWidget *widget, QString replacement )
{
    if( original.isNull() ) {
