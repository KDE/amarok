...
class CurrentPlugin : public QQmlExtensionPlugin
{
    Q_OBJECT
...
public:
    ...
    static QObject *current_engine_provider(QQmlEngine *engine, QJSEngine *scriptEngine)
    {
        Q_UNUSED(engine)
        Q_UNUSED(scriptEngine)

        return new CurrentEngine();
    }
};

#include <CurrentPlugin.moc>
