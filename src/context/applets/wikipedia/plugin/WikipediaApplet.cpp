...
WikipediaAppletPrivate::_paletteChanged( const QPalette &palette )
{
    ...
    QFile file( QStandardPaths::locate("data", "amarok/data/WikipediaCustomStyle.css" ) );
...
WikipediaApplet::init()
{
    ...
    d->_paletteChanged( pApp->palette() );
...
WikipediaApplet::createConfigurationInterface( KConfigDialog *parent )
{
    ...
    connect( d->languageSettingsUi.downloadButton, &QPushButton::clicked, this, SLOT(_getLangMap()) );
