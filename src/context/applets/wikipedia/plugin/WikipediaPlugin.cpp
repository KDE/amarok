...
class WikipediaPlugin : public QQmlExtensionPlugin
{
    Q_OBJECT
...
public:
    ...
    static QObject *wikipedia_engine_provider(QQmlEngine *engine, QJSEngine *scriptEngine)
    {
        Q_UNUSED(engine)
        Q_UNUSED(scriptEngine)

        return new WikipediaEngine();
    }
};
