...
QTemporaryDir *TestSqlAlbumBase::s_tmpDir = nullptr;

TestSqlAlbumBase::TestSqlAlbumBase()
    : QObject()
    , m_collection( nullptr )
    , m_storage( nullptr )
{
    KLocalizedString::setApplicationDomain("amarok-test");
    std::atexit([]() { delete TestSqlAlbumBase::s_tmpDir; } );
}
...
void
TestSqlAlbumBase::cleanupTestCase()
{
    delete m_collection;
}

void
TestSqlAlbumBase::init()
{
    //setup base data
...
void
TestSqlAlbumBase::testIsCompilation()
{
    m_storage->query( QStringLiteral("INSERT INTO albums(id,name,artist) VALUES (1, 'album1',1);") );
    m_storage->query( QStringLiteral("INSERT INTO tracks(id,url,title,artist,album,genre,year,composer) "
                      "VALUES (1,1,'track1',1,1,1,1,1 );") );
...
void
TestSqlAlbumBase::testAlbumArtist()
{
    m_storage->query( QStringLiteral("INSERT INTO albums(id,name,artist) VALUES (1, 'album1',1);") );
...
void
TestSqlAlbumBase::testCapabilities()
{
...
void
TestSqlAlbumBase::testSetCompilationWithoutExistingCompilation()
{
    m_collection->registry()->emptyCache();
...
void
TestSqlAlbumBase::testSetCompilationWithExistingCompilation()
{
...
void
TestSqlAlbumBase::testUnsetCompilationWithoutExistingAlbum()
{
...
void
TestSqlAlbumBase::testUnsetCompilationWithExistingAlbum()
{
...
void
TestSqlAlbumBase::testUnsetCompilationWithMultipleExistingAlbums()
{
    m_storage->query( QStringLiteral("INSERT INTO albums(id,name,artist) VALUES (1,'albumAndCompilation1',NULL);") );
    m_storage->query( QStringLiteral("INSERT INTO albums(id,name,artist) VALUES (2,'albumAndCompilation1',1);") );
...
void
TestSqlAlbumBase::testUnsetCompilationWithArtistAFeaturingB()
{
...
void
TestSqlAlbumBase::testUnsetCompilationWithMultipleArtists()
{
    m_storage->query( QStringLiteral("INSERT INTO albums(id,name,artist) VALUES (1,'album1',NULL);") );
