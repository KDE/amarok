...
QTemporaryDir *TestSqlCollectionLocationBase::s_tmpDir = nullptr;

TestSqlCollectionLocationBase::TestSqlCollectionLocationBase()
    : QObject()
    , m_collection( nullptr )
    , m_storage( nullptr )
{
    KLocalizedString::setApplicationDomain("amarok-test");
    std::atexit([]() { delete TestSqlCollectionLocationBase::s_tmpDir; } );
    int argc = 1;
...
void
TestSqlCollectionLocationBase::cleanupTestCase()
{
    delete m_collection;
...
void
TestSqlCollectionLocationBase::init()
{
    //setup base data
...
void
TestSqlCollectionLocationBase::testOrganizingCopiesLabels()
{
    {
...
void
TestSqlCollectionLocationBase::testCopiesLabelFromExternalTracks()
{

}

void
TestSqlCollectionLocationBase::testCopyTrackToDirectoryWithExistingTracks()
{

}

QString
TestSqlCollectionLocationBase::setupFileInTempDir( const QString &relativeName )
{
...
void
TestSqlCollectionLocationBase::test2100sChangeDate()
{
