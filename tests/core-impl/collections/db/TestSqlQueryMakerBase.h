...
#ifndef TESTSQLQUERYMAKERBASE_H
#define TESTSQLQUERYMAKERBASE_H
...
class TestSqlQueryMakerBase : public QObject
{
    Q_OBJECT
public:
    TestSqlQueryMakerBase();
