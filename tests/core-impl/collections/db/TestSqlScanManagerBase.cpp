...
QTemporaryDir *TestSqlScanManagerBase::s_tmpDatabaseDir = nullptr;

TestSqlScanManagerBase::TestSqlScanManagerBase()
    : QObject()
{
    QString help = i18n("Amarok"); // prevent a bug when the scanner is the first thread creating a translator
    std::atexit([]() { delete TestSqlScanManagerBase::s_tmpDatabaseDir; } );
}

void
TestSqlScanManagerBase::cleanupTestCase()
{
...
void
TestSqlScanManagerBase::cleanup()
{
    m_collection->registry()->emptyCache();
}

void
TestSqlScanManagerBase::testScanSingle()
{
...
void
TestSqlScanManagerBase::testScanDirectory()
{
    createAlbum();
    fullScanAndWait();
...
void
TestSqlScanManagerBase::testDuplicateUid()
{
...
void
TestSqlScanManagerBase::testLongUid()
{
    Meta::FieldHash values;
...
void
TestSqlScanManagerBase::testCompilation()
{
    createAlbum();
    createCompilation();
...
void
TestSqlScanManagerBase::testBlock()
{
...
void
TestSqlScanManagerBase::testAddDirectory()
{
    createAlbum();
    fullScanAndWait();
...
void
TestSqlScanManagerBase::testRemoveDir()
{
    Meta::AlbumPtr album;
...
void
TestSqlScanManagerBase::testUidChangeMoveDirectoryIncrementalScan()
{
    createAlbum();
    fullScanAndWait();
...
void
TestSqlScanManagerBase::testRemoveTrack()
{
    Meta::AlbumPtr album;
    Meta::TrackPtr track;
    QDateTime aDate = QDateTime::currentDateTime();
...
void
TestSqlScanManagerBase::testMove()
{
    createAlbum();
    createCompilation();
...
void
TestSqlScanManagerBase::testFeat()
{
    Meta::FieldHash values;
...
void
TestSqlScanManagerBase::testAlbumImage()
{
    createSingleTrack();
    createAlbum();
    createCompilation();
...
void
TestSqlScanManagerBase::testMerges()
{
...
void
TestSqlScanManagerBase::testLargeInsert()
{
    if( qgetenv("AMAROK_RUN_LONG_TESTS").isNull() )
        QSKIP( "takes too long to be run by default;\nDefine AMAROK_RUN_LONG_TESTS "
               "environment variable to run all tests.", SkipAll );
...
void
TestSqlScanManagerBase::testIdentifyCompilationInMultipleDirectories()
{
...
void
TestSqlScanManagerBase::testAlbumArtistMerges()
{
...
void
TestSqlScanManagerBase::testCrossRenaming()
{
    createAlbum();
...
void
TestSqlScanManagerBase::testPartialUpdate()
{
    Meta::FieldHash values;
    Meta::AlbumPtr album;
...
void
TestSqlScanManagerBase::slotCollectionUpdated()
{
    m_collectionUpdatedCount++;
}

void
TestSqlScanManagerBase::fullScanAndWait()
{
...
void
TestSqlScanManagerBase::incrementalScanAndWait( const QList<QUrl> &paths )
{
...
void
TestSqlScanManagerBase::importAndWait( QIODevice* input )
{
...
void
TestSqlScanManagerBase::waitScannerFinished()
{
    QVERIFY( m_scanManager->isRunning() );
    ...
    QSignalSpy resultSpy( this, &TestSqlScanManagerBase::scanManagerResult );

    // connect the result signal *after* the spies to ensure they are updated first
    connect( m_scanManager, &GenericScanManager::succeeded, this, &TestSqlScanManagerBase::scanManagerResult );
    connect( m_scanManager, &GenericScanManager::failed, this, &TestSqlScanManagerBase::scanManagerResult);
    const bool ok = resultSpy.wait( 5000 );
    disconnect( m_scanManager, &GenericScanManager::succeeded, this, &TestSqlScanManagerBase::scanManagerResult );
    disconnect( m_scanManager, &GenericScanManager::failed, this, &TestSqlScanManagerBase::scanManagerResult );
...
void
TestSqlScanManagerBase::createTrack( const Meta::FieldHash &values )
{
...
void
TestSqlScanManagerBase::createSingleTrack()
{
    Meta::FieldHash values;
...
void
TestSqlScanManagerBase::createAlbum()
{
    Meta::FieldHash values;
...
void
TestSqlScanManagerBase::createCompilation()
{
...
void
TestSqlScanManagerBase::createCompilationLookAlikeAlbum()
{
    Meta::FieldHash values;
...
void
TestSqlScanManagerBase::createCompilationTrack()
{
    Meta::FieldHash values;
