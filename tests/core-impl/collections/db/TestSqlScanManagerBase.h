...
#ifndef TESTSQLSCANMANAGERBASE_H
#define TESTSQLSCANMANAGERBASE_H
 ...
 */
class TestSqlScanManagerBase : public QObject
{
    Q_OBJECT
public:
    TestSqlScanManagerBase();
...
#endif // TESTSQLSCANMANAGERBASE_H
