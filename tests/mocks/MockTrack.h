...
class MockTrack : public Meta::Track
{
    ...
    MOCK_METHOD( void, setScore, (double score) );
    MOCK_METHOD( int, rating, (), ( const ) );
    MOCK_METHOD( void, setRating, (int rating) );
    ...
    MOCK_METHOD( QDateTime, lastPlayed, (), ( const ) );
    MOCK_METHOD( QDateTime, firstPlayed, (), ( const ) );
    MOCK_METHOD( int, playCount, (), ( const ) );
